			...
			if(mysqli_num_rows($result)>0) //if there are data
			{
				while($row=mysqli_fetch_array($result))
				{
					...
					<tr>
						...
						<td>
							<div id="edit">
								<a href="G22_book_edit.php?edit&id=<?php echo $row["book_id"];?>">
								<button>
						...
						<td>
							<div id="dlt">
								<a href="G22_book_editdelete.php?del&id=<?php echo $row["book_id"];?>" onclick="return confirmation();">
								<button>
...
<?php
	if(isset($_REQUEST["del"])) 
	{
		...
		echo'<script>window.location="G22_book_editdelete.php";</script>';
	}
?>